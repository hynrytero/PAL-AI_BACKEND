...
const DEFAULT_IMAGE_URL = "https://your-https://storage.googleapis.com/pal-ai_profile_image_bucket/1740665938530-profile.jpg-domain.com/path/to/default-image.jpg";
    ...
    try {
        ...
        if (Expo.isExpoPushToken(token)) {
            const messages = [{
                ...
                mutableContent: true,
                categoryId: 'image-notification',
                channelId: 'notification-channel',
                // Add your static image URL
